...
# Vendored from sketchybar-app-font v2.0.62:
#   https://github.com/kvndrsslr/sketchybar-app-font
# Generated file — do not edit by hand. To update, download icon_map.sh
# from a newer release and keep this header.
#
# Maps an application name to a ligature token such as :slack:, which the
# sketchybar-app-font renders as that app icon. Unknown apps map to
# :default:, so a new app degrades to a generic glyph rather than blank.
